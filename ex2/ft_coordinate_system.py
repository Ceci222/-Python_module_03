...
#  If it does it starts again, else it keeps going till it meets a return and then stops
...
def main() -> None:
    ...
    print(f"Distance to center: {round(distance_center, 4)}") #  rounds to 4 decimals
    print()
